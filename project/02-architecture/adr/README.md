...
| [ADR-0004](./ADR-0004-toolchain-and-test-stack.md) | 构建与测试技术栈 | Proposed | WXT/Vite + TS/Vitest/Playwright，Phase 0 spike 验证 |
| [ADR-0005](./ADR-0005-permission-minimization.md) | 权限最小化与远程能力 | Proposed | 默认无全站网络拦截、无远程代码 |
