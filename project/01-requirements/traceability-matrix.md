...
| FR-SESSION-003 | selection heuristics/capabilities | EXT-042, EXT-049 | 广告小窗/背景媒体 fixture + differential | 2 | Planned |

## 2. 核心命令与快捷键

| 需求 | 模块 | 任务 | 自动化证据 | Phase | 当前证据状态 |
| --- | --- | --- | --- | --- | --- |
| FR-CORE-001 | command registry/media handlers | EXT-044, EXT-045, EXT-046 | command unit + basic E2E + differential | 2 | Planned |
| FR-CORE-002 | volume handler | EXT-046 | range/NaN/mute unit + E2E | 2 | Planned |
| FR-CORE-003 | media policy/hook adapter | EXT-046, EXT-047 | hostile property-reset fixture | 2/3 | Planned |
| FR-CORE-004 | domain/command | EXT-044 | registry contract；UI/hotkey dispatch integration | 2 | Planned |
| FR-CORE-005 | capability-aware commands | EXT-044, EXT-081, EXT-100 | capability matrix + adapter fixture | 2/4/5 | Planned |
...
| 需求 | 模块 | 任务 | 自动化证据 | Phase | 当前证据状态 |
| --- | --- | --- | --- | --- | --- |
| FR-ADAPTER-001 | adapters/generic | EXT-043 | 无站点配置 core fixture | 2 | Planned |
